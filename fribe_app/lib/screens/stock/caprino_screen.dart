...
class CaprinoScreen extends StatefulWidget {
  const CaprinoScreen({super.key});

  @override
  State<CaprinoScreen> createState() => _CaprinoScreenState();
}

class _CaprinoScreenState extends State<CaprinoScreen> {
  final TextEditingController codController = TextEditingController();
  final TextEditingController nameController = TextEditingController();
  final TextEditingController quantityController = TextEditingController();
  final TextEditingController priceController = TextEditingController();
  String selectedCategory = "CAPRINO";
    ...
    return Scaffold(
      ...
      body: Center(
        child: StreamBuilder<QuerySnapshot>(
          stream:
              collectionRef.where('categoria', isEqualTo: 'CAPRINO').snapshots(),
